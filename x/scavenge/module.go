...
import (
	...
	"github.com/ilovelili/scavenge/x/scavenge/client/cli"
	"github.com/ilovelili/scavenge/x/scavenge/client/rest"
)
...
func NewAppModule(k Keeper, coinKeeper bank.Keeper) AppModule {
	return AppModule{
